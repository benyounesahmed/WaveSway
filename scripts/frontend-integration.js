 ...
 * This file demonstrates how to integrate Wavesway with a web frontend
 */

// For React/Vue/Angular applications
export class WaveswayClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new WaveswayClient(provider, contractAddress);
